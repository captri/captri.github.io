...
$$\begin{theorem}$$ Sean $$E\subset\mathbb{R}^n$$ abierto que contiene al origen, $$f\in C^1(E)$$ y $$\varphi_t$$ el flujo del sistema no lineal $$x'=f(x)$$. Suponiendo que $$f(0)$$ y que la matriz $$$$
